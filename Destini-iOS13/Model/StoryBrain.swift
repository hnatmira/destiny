...
//        choice1Button.setTitle(stories[storyNumber].choice1, for: UIControl.State.normal)
//        choice2Button.setTitle(stories[storyNumber].choice2, for: UIControl.State.normal)
//    }
